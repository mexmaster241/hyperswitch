...
use hyperswitch_domain_models::{
    ...
    router_data_v2::{
        flow_common_types::{
            AccessTokenFlowData, DisputesFlowData, ExternalAuthenticationFlowData, FilesFlowData, GetAdditionalRecoveryDataCommon, MandateRevokeFlowData, PaymentFlowData, RefundFlowData, UasFlowData, WebhookSourceVerifyData
        },
        RouterDataV2,
    },
};
...
impl<T, Req: Clone, Resp: Clone> RouterDataConversion<T, Req, Resp> for GetAdditionalRecoveryDataCommon {
