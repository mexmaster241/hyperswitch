...
pub type BoxedGetAdditionalRecoveryDetailsIntegrationInterface<T,Req,Res> =
    BoxedConnectorIntegrationInterface<T, common_types::GetAdditionalRecoveryDataCommon, Req, Res>;
